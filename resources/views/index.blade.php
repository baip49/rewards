   ...
   <div class="container-fluid">
      <div class="row d-flex align-items-center">
         <div class="col d-flex justify-content-center">
            <div class="card text-center mb-3 border-0 w-full" style="width: 18rem;">
               <div class="card-body">
            ...
            <div class="card text-center mb-3 border-0 w-full" style="width: 18rem;">
               <div class="card-body">
                  ...
                  <h3 class="card-title"
                     ...
                     Panel de recompensas</h3>
                  <p class="card-text">{{ __('index.panel-desc') }}</p>
                  </p>
                  @if (auth()->check())
                     <a href="{{ route('dashboard') }}" class="btn btn-outline-success">{{ __('index.panel-btn') }}</a>
                  @else
         ...
         <div class="col d-flex justify-content-center">
            <div class="card text-center mb-3 border-0 w-full" style="width: 18rem;">
               <div class="card-body">
                  ...
                  @if (auth()->check())
                     <a href="{{ route('dashboard') }}" class="btn btn-outline-info">{{ __('index.points-btn') }}</a>
                  @else
